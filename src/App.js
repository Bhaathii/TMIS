...
const AppRoutes = () => {
    ...
    return (_jsx(Routes, { children: currentUser ? (_jsxs(_Fragment, { children: [_jsx(Route, { path: "/dashboard", element: _jsx(BrowsePage, {}) }), _jsx(Route, { path: "/create", element: _jsx(CreateEditPage, {}) }), _jsx(Route, { path: "/edit/:id", element: _jsx(CreateEditPage, {}) }), _jsx(Route, { path: "/view/:id", element: _jsx(ViewDetailPage, {}) }), _jsx(Route, { path: "/", element: _jsx(Navigate, { to: "/dashboard", replace: true }) }), _jsx(Route, { path: "/login", element: _jsx(Navigate, { to: "/dashboard", replace: true }) })] })) : (_jsxs(_Fragment, { children: [_jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/login", replace: true }) })] })) }));
};
function App() {
